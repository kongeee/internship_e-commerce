...
<body>
    ...
    <div id="computer_add_form" style="margin-left: 40%;">
        ...
        <form action="computer_add.php" method="POST">
            <table>
                <tr>
    ...
    <?php }else{
        ...
        $computer->setName($_POST['name']);
        $computer->setCpu($cpu[0]);
        $computer->setCpuBench($cpu[1]);
        $computer->setGpu($gpu[0]);
        $computer->setGpuBench($gpu[1]);
        $computer->setRam($_POST['ram']);
        $computer->setStorage($_POST['storage']);
        $computer->setPrice($_POST['price']);
        $computer->setType($_POST['type']);
        $computer->setDescription($_POST['description']);
